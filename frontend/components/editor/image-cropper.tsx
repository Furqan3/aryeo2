...
export function ImageCropper({ imageUrl, onCropComplete, onCancel, aspectRatio }: ImageCropperProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/95 flex items-center justify-center p-4" ref={containerRef}>
      <div className="w-full h-full flex flex-col gap-4 max-w-7xl">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-400 mt-1">
              Drag handles to adjust • Press Enter to confirm • Press Esc to cancel
            </p>
          </div>
        ...
        <div className="flex-1 flex items-center justify-center overflow-auto">
          <canvas
            ref={canvasRef}
            className="max-w-full max-h-full border-2 border-blue-500/20 rounded shadow-2xl"
